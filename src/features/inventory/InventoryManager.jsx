  ...
  return (
    <section className="erp-page inventory-page">
      ...
      <section className="erp-panel inventory-list-panel" aria-labelledby="inventory-list-title">
        ...
        {loading ? <SkeletonRegion label="Cargando inventario…"><SkeletonTable className="erp-desktop-only" columns={7} twoLine /><SkeletonCards className="erp-card-list erp-mobile-only" /></SkeletonRegion> : visibleItems.length === 0 ? (
