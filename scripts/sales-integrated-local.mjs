...
try {
  ...
  assert.equal(acceptedSale.efectosInventario.length, 1); assert.equal(acceptedSale.efectosInventario[0].costoUnitario, 3500); assert.equal(acceptedSale.efectosInventario[0].costoTotal, 7000);
