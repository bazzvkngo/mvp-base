...
assert.match(emulatorStartSource, /"--import", dataDirectory, "--export-on-exit"/);
assert.match(emulatorStartSource, /"--export-on-exit", dataDirectory/);
assert.match(emulatorStartSource, /firebase-export-/);
assert.doesNotMatch(emulatorStartSource, /emulators:export/);
